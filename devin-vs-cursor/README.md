...
- [research/](research/) — annotated primary-source research with confidence tags
- [index.html](index.html) — the report as a website, styled after Cognition's engineering blog

Status: planning phase. Hands-on evaluation not yet run.
